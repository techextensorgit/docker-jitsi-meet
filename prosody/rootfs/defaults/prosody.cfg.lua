...
{{ $TRUSTED_PROXIES := .Env.PROSODY_TRUSTED_PROXIES | default "194.61.31.166,::1" -}}
...
modules_enabled = {
	...
	-- Admin interfaces
		...
		--"admin_telnet"; -- Opens telnet console interface on 194.61.31.166 port 5582
...
--sql = { driver = "MySQL", database = "prosody", username = "prosody", password = "secret", host = "194.61.31.166" }
--sql = { driver = "PostgreSQL", database = "prosody", username = "prosody", password = "secret", host = "194.61.31.166" }
